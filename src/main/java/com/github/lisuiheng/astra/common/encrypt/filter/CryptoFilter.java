...
import com.github.lisuiheng.astra.common.constant.HttpStatus;
...
import com.github.lisuiheng.astra.common.encrypt.properties.ApiDecryptProperties;
...
public class CryptoFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (ObjectUtil.isNull(requestWrapper) && ObjectUtil.isNull(responseWrapper)) {
            chain.doFilter(request, response);
        } else if (ObjectUtil.isNotNull(requestWrapper) && ObjectUtil.isNull(responseWrapper)) {
            chain.doFilter(requestWrapper, response);
        } else if (ObjectUtil.isNull(requestWrapper) && ObjectUtil.isNotNull(responseWrapper)) {
    ...
    private ApiEncrypt getApiEncryptAnnotation(HttpServletRequest servletRequest) {
        ...
        // 获取注解
        try {
            Object handler = handlerMapping.getHandler(servletRequest).getHandler();
