...
public class SysTenantPackageController {
    ...
    public R<SysTenantPackageVo> getInfo(@NotNull(message = "租户套餐主键不能为空") @PathVariable Long packageId) {
    ...
    public R<Void> changeStatus(@RequestBody SysTenantPackageBo bo) {
        return toAjaxByInt(tenantPackageService.updatePackageStatus(bo));
    }
    ...
    private R<Void> toAjaxByInt(int result) {
