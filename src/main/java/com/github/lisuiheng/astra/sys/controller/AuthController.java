...
import com.github.lisuiheng.astra.common.domain.model.LoginBody;
import com.github.lisuiheng.astra.common.domain.model.RegisterBody;
import com.github.lisuiheng.astra.common.domain.model.SocialLoginBody;
import com.github.lisuiheng.astra.common.encrypt.annotation.ApiEncrypt;
import com.github.lisuiheng.astra.common.json.utils.JsonUtils;
import com.github.lisuiheng.astra.common.ratelimiter.annotation.RateLimiter;
...
import com.github.lisuiheng.astra.sys.config.properties.SocialLoginConfigProperties;
import com.github.lisuiheng.astra.sys.config.properties.SocialProperties;
import com.github.lisuiheng.astra.common.social.utils.SocialUtils;
import com.github.lisuiheng.astra.common.sse.dto.SseMessageDto;
import com.github.lisuiheng.astra.common.sse.utils.SseMessageUtils;
...
import com.github.lisuiheng.astra.sys.domain.vo.LoginTenantVo;
import com.github.lisuiheng.astra.sys.domain.vo.LoginVo;
import com.github.lisuiheng.astra.sys.domain.vo.TenantListVo;
...
import com.github.lisuiheng.astra.sys.service.impl.SysLoginService;
import com.github.lisuiheng.astra.sys.service.impl.SysRegisterService;
...
public class AuthController {
    ...
    public R<String> testGet() {
        try {
            log.info("测试GET方法被调用");
            return R.ok("测试成功", "这是一个测试GET方法的返回值");
        } catch (Exception e) {
            log.error("测试GET方法失败: ", e);
