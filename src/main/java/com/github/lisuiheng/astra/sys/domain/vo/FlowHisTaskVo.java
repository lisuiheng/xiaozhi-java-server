...
import com.github.lisuiheng.astra.common.utils.DateUtils;
import lombok.Data;
...
public class FlowHisTaskVo implements Serializable {
    ...
    public void setCooperateType(Integer cooperateType) {
        ...
        // 这里需要根据实际的CooperateType枚举来获取名称
        this.cooperateTypeName = getCooperateTypeNameByValue(cooperateType);
    }

    /**
     * 根据协作类型值获取名称
     */
    private String getCooperateTypeNameByValue(Integer value) {
        if (value == null) {
            return null;
        }
        switch (value) {
